...
{
    // Ensure the game is ready, no menu is open, and the location is "BusStop"
    if (!Context.IsWorldReady || Game1.activeClickableMenu != null || 
        !Game1.currentLocation.Name.Contains("BusStop") || 
    ...
    if (cursorTile.X == 17 && cursorTile.Y >= 10 && cursorTile.Y <= 12)
    {
